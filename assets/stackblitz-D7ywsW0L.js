...
import '${n}';`},template:"node",title:`${t}`,description:"This is a generated project via https://docs.needle.engine. Please note that this feature is experimental(!) and the project might not work as expected."},{newWindow:!0,openFile:n})}}},S={class:"code"};function v(e,n,t,o,a,s){return f(),b("div",null,[g("button",{onClick:n[0]||(n[0]=(...i)=>s.openProject&&s.openProject(...i)),class:"plausible-event-name=Click+Create+Stackblitz+Project"}," Open in StackBlitz "),g("div",S,[w(e.$slots,"default")])])}const _=h(P,[["render",v],["__file","stackblitz.vue"]]);export{_ as default};
