...
`,e[d]=t,d}const P={props:{file:String},methods:{async openProject(){const e={};await y(e,"https://github.com/needle-engine/vite-template/raw/main/assets/basic.glb");const n=await j(e,this.file),t=n.split("/").pop();StackBlitzSDK.openProject({files:{...e,"index.ts":`import './src/main';
import '${n}';`},template:"node",title:`${t}`,description:"This is a generated project via https://docs.needle.engine. Please note that this feature is experimental(!) and the project might not work as expected."},{newWindow:!0,openFile:n})}}},S={class:"code"};function v(e,n,t,o,a,s){return b(),f("div",null,[g("button",{onClick:n[0]||(n[0]=(...i)=>s.openProject&&s.openProject(...i)),class:"plausible-event-name=Click+Create+Stackblitz+Project"}," Open in StackBlitz "),g("div",S,[w(e.$slots,"default")])])}const _=h(P,[["render",v],["__file","stackblitz.vue"]]);export{_ as default};
